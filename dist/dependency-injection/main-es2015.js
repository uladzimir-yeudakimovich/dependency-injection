...
/* harmony import */ var _accounts_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../accounts.service */ "./src/app/accounts.service.ts");




let AccountComponent = class AccountComponent {
    constructor(loggingService, accountsService) {
...
/* harmony import */ var _new_account_new_account_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./new-account/new-account.component */ "./src/app/new-account/new-account.component.ts");
/* harmony import */ var _accounts_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./accounts.service */ "./src/app/accounts.service.ts");
...
let NewAccountComponent = class NewAccountComponent {
    constructor(loggingService, accountsService) {
        this.loggingService = loggingService;
        this.accountsService = accountsService;
        this.accountsService.statusApdated.subscribe((status) => alert('New status ' + status));
    }
...
NewAccountComponent.ctorParameters = () => [
    { type: _logging_service__WEBPACK_IMPORTED_MODULE_2__["LoggingService"] },
    { type: _accounts_service__WEBPACK_IMPORTED_MODULE_3__["AccountsService"] }
];
NewAccountComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./new-account.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/new-account/new-account.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./new-account.component.scss */ "./src/app/new-account/new-account.component.scss")).default]
    })
], NewAccountComponent);
...
module.exports = __webpack_require__(/*! C:\Users\Vova.Evdokimovich\Desktop\dependency-injection\src\main.ts */"./src/main.ts");
